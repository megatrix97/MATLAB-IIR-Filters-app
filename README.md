...
A butter-worth filter is used in the entire app. A sample signal which is a combination of sinusoidal signals with different amplitudes at frequencies 25Hz, 50Hz, 100Hz is used (no option is given to change this signal, to change it look into section 1.2)
